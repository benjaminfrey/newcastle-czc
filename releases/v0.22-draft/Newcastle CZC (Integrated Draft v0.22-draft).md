...
2. **Applicability.** A Driveway provides access to no more than two single family dwellings or one two-family dwelling on a single lot, except where a shared driveway is authorized under Section 7.C.3. An access way that comes to serve more than this is no longer a Driveway and is improved to its assigned Thoroughfare Type under Section 7.F.
...
3. **Preservation of Significant Street Trees.** A Significant Street Tree within the right-of-way of a Street shall be preserved where reasonably feasible. For work performed by the Town, or by an applicant under this Article, within the right-of-way of a Street:
    ...
    b. Where removal of a Significant Street Tree is unavoidable, it shall be replaced in kind within the same segment by one or more street trees whose combined caliper equals or exceeds the caliper of the tree removed, subject to the spacing and growing-condition standards of this Section; where on-segment replacement is infeasible, the Code Enforcement Officer may approve replacement on a nearby Street segment.
...
3. To fix each segment's required standard in advance, so that a property owner, the Code Enforcement Officer, and the Planning Board can determine the standard applicable to a segment from the adopted Inventory without a separate Type determination at the time of development.
...
6. **Effect of classification; certainty.** Because the Inventory assigns each segment its Thoroughfare Type at adoption (paragraph 2), the standard applicable to a segment is fixed when this Article takes effect. No determination of a segment's Type by the Code Enforcement Officer or Planning Board, and no amendment of this Code, is required at the time a segment is developed, reconstructed, or improved; the assigned Type governs. A Type is changed only by Reclassification under Section 5.E.
...
7. A Driveway that comes to serve more than two single-family dwellings, or more than one two-family dwelling, whether on one lot or on several, is no longer a Driveway under this Section. The access way is thereafter a Street or Road and is improved to its assigned Thoroughfare Type as provided in Section 7.F.
