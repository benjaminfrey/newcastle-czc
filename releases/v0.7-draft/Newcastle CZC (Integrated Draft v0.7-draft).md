...
<!-- The ten Street/Road Type cross-section plates (S-1..S-5, R-1..R-5) are
     rendered as full-page graphics from source/cross-section-plates.typ
     (compositing source/exhibits/cross-sections/<CODE>.svg). See the
     Integrated Draft PDF for the per-Type plate pages at the end of Article 3. -->
